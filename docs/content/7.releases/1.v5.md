...
SEO Utils v8 adds inline script and style minification: build mode via Rolldown/esbuild, runtime mode via lightweight JS minifiers.
...
Named priority constants are now available via `SiteConfigPriority.runtime`{lang="ts"}, etc.
