...
- Locale domain support ([#155](https://github.com/nuxt/sitemap/issues/155))
- Support pages opt-outed using `defineI18nRoute(false)` ([#126](https://github.com/nuxt/sitemap/issues/126))
...
Video entries are now supported properly. ([#159](https://github.com/nuxt/sitemap/issues/159))
