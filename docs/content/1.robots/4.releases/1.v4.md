...
## :icon{name="noto:rocket"} Features

### Robots.txt validation :icon{name="noto:check-mark-button"}
...
### Default Meta Tag :icon{name="noto:relieved-face"}
...
### I18n Integration :icon{name="noto:globe-with-meridians"}
...
Learn more on the [I18n Integration](/robots/guides/i18n-integration) docs.

### Nuxt Content Integration :icon{name="noto:books"}
...
### Nuxt DevTools Integration :icon{name="noto:hammer"}
...
### New Nitro Hook and Util Exports :icon{name="noto:hook"}
...
## :icon{name="noto:warning"} Deprecations
