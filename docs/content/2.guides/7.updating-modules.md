...
Since `@nuxtjs/seo` bundles the core submodules, you only need to update the main package. Update standalone modules like `nuxt-skew-protection` and `nuxt-ai-ready` independently.
