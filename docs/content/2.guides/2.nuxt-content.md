...
The Nuxt Content setup is identical whether you installed `@nuxtjs/seo` or the modules individually. Each module provides its own `defineXxxSchema()` function that you compose in your collection schema. You only need to include schemas for the modules you actually use.
::
...
You only need to include the schemas for the modules you use. For example, if you only need sitemap and robots support, just include those two:
