...
**`validate_schema`**: validate Schema.org structured data on any URL. Detects JSON-LD and Microdata markup.
...
**`nuxt-seo://reference`**: complete reference for all modules, config, and schema.org patterns in one resource.
