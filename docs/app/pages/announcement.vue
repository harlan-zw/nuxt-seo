...
- New learning resources to help you with your technical SEO, check out the [Mastering Page Titles in Vue & Nuxt](/learn/mastering-titles-in-nuxt) guide.
...
<template>
  <div>
    <div class="gradient" />
    <section class="max-w-xl mx-auto py-5 sm:py-12 xl:py-20">
      <UPageHeader title="Introducing Nuxt SEO" description="The stable v2 release of Nuxt SEO is here, learn about the history and what's next." />
      <div>
        <MDC :value="md" />
      </div>
    </section>
