...
import { explicitModules } from '../../../../src/const'
...
<template>
  ...
  >
    ...
    />
    <div class="flex absolute right-5 top-[200px] w-[300px] gap-5">
      <UIcon v-for="(module, key) in explicitModules" class="text-blue-500 w-20 h-20" mode="svg" dynamic :name="module.icon" />
    </div>
    <div class="h-full w-full relative">
      <svg height="40" viewBox="0 0 1204 200" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="mt-[30px] max-w-[700px] flex justify-center gap-7 flex-col">
