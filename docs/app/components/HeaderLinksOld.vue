    ...
    <div class="flex items-center gap-6">
      ...
      >
        <NavigationMenuList class="center shadow-green-700/10 m-0 flex list-none rounded-[6px] p-1 shadow-[0_2px_5px]">
          <NavigationMenuItem>
            <NavigationMenuTrigger
              class="hover:bg-green3 focus:shadow-green7 group flex select-none items-center justify-between gap-[2px] rounded-[4px] px-3 py-2 text-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px]"
            >
              Learn
              <UIcon
      ...
      <div class="lg:space-x-5 space-x-2 lg:mr-5 pr-2 flex">
        <UPopover class="hidden md:block" mode="hover" :items="[items]" :popper="{ placement: 'bottom' }">
          ...
          <UButton label="Learn" variant="ghost" class="hover:bg-green-100 dark:hover:bg-green-950 transition" trailing-icon="i-heroicons-chevron-down" />
        </UPopover>
        ...
        <UPopover class="hidden md:block" mode="hover" :items="[items]" :popper="{ placement: 'bottom' }">
          ...
          <UButton label="Modules" variant="ghost" class="hover:bg-green-100 dark:hover:bg-green-950 transition" trailing-icon="i-heroicons-chevron-down" />
        </UPopover>
        <UPopover class="hidden md:block" mode="hover" :items="[items]" :popper="{ placement: 'bottom' }">
          <template #panel>
            <div class="p-4 space-y-4 dark:bg-[#1b2335]">
          ...
          <UButton label="Support" variant="ghost" class="hover:bg-green-100 dark:hover:bg-green-950 transition" trailing-icon="i-heroicons-chevron-down" />
        </UPopover>
        <UPopover class="hidden md:block" mode="hover" :items="[items]" :popper="{ placement: 'bottom' }">
          <template #panel>
            <div class="p-4 space-y-4 dark:bg-[#1b2335]">
          ...
          <UButton label="Ecosystem" variant="ghost" class="hover:bg-green-100 dark:hover:bg-green-950 transition" trailing-icon="i-heroicons-chevron-down" />
        </UPopover>
      </div>
    </div>
