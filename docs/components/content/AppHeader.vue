  ...
  <header :class="{ 'has-dialog': hasDialog, 'has-doc-search': hasDocSearch }">
    <Container fluid>
      ...
      <section class="right">
        ...
        <GithubButton class="hidden xl:inline h-[20px]" href="https://github.com/harlanzw/nuxt-seo-kit" :data-color-scheme="githubColorScheme" data-icon="octicon-star" data-show-count="true" aria-label="Star on GitHub">
          Star
        </GithubButton>
