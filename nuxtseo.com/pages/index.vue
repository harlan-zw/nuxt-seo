    ...
    <section class="py-5 sm:py-12 xl:py-20">
      <div class=" ">
        <div class="flex flex-col justify-center">
          <div class="text-lg mb-3 text-green-300">
            Become a Nuxt growth hackers:
          </div>
          <h1 class="mb-5 text-gray-900/90 dark:text-gray-100 text-center text-4xl leading-tight font-bold tracking-tight sm:text-5xl lg:text-left lg:text-5xl" style="line-height: 1.3;">
            <div class="max-w-3xl ">
              ✅ Finish the boring SEO work.
            </div>
          </h1>
          <h1 class="text-gray-900/90 dark:text-gray-100 text-center text-4xl leading-tight font-bold tracking-tight sm:text-5xl lg:text-left lg:text-5xl" style="line-height: 1.3;">
            <div class="max-w-xl ">
              ⬜ Grow organics.
            </div>
          </h1>
