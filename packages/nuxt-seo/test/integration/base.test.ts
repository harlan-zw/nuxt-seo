...
describe('base url', () => {
  ...
  it('og-image - url', async () => {
    ...
    expect(ogImageUrl).toMatchInlineSnapshot(`"https://local.nuxtseo.com/base/_og/d/description_Fully+equipped+Technical+SEO+for+busy+Nuxters.,ch_tjb25mqs8mf6.png"`)
  })
